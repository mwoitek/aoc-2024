...
struct Map {
    ...
    ulong computeScore(in Position trailhead)
    {
    ...
    ulong computeTotalScore()
    {
        findTrailheads();
        ulong total = 0;
        foreach (trailhead; trailheads)
            total += computeScore(trailhead);
        return total;
    }
}
...
void main(string[] args)
{
    ...
    const ulong score = inputMap.computeTotalScore;
    sw.stop;
